        ...
        <div class="row">
            <div class="col-md-4 col-xs-6">
                <div class="input-group input-group-sm mb-3">
                    ...
                    <input name="playerName" list="playerNames" placeholder="Account" class="form-control">
            ...
            <div class="col-md-4 col-xs-6">
                <div class="input-group input-group-sm mb-3">
                    ...
                    <input name="tribeName" list="tribeNames" placeholder="Stamm" class=" form-control">
            ...
            <div class="col-md-4 col-xs-6">
                <div class="input-group input-group-sm mb-3">
                    ...
                    <input type="text" id="coordY" maxlength="3" name="coordY" placeholder="500" class="form-control">
                </div>
            </div>
            <div class="col-md-4 col-xs-6">
                <div class="input-group input-group-sm mb-3">
            ...
            <div class="col-md-4 col-xs-6">
                <div class="input-group input-group-sm mb-3">
                    ...
                    <input type="text" name="continent" class="form-control" placeholder="55" maxlength="2">
                </div>
            </div>
            <div class="col-3">
            </div>
            <div class="col-lg-2 col-md-2 col-xs-12 me-2 d-flex justify-content-center">
                <div class="form-check">
                    <input class="form-check-input" name="watchtower" type="checkbox">
            ...
            <div class="col-lg-2 col-md-2 col-xs-12 d-flex justify-content-center">
                <div class="form-check">
                    <input class="form-check-input" name="church" type="checkbox">
                    <label class="form-check-label">
                        Kirche
                    </label>
                </div>
            ...
            <div class="col-lg-2 col-md-2 col-xs-12 d-flex justify-content-center">
                <div class="form-check">
                    <input class="form-check-input" name="academy" type="checkbox">
                    <label class="form-check-label">
                        Adelshof
                    </label>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-xs-6">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <input name="attackerName" list="playerNames" placeholder="Account" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-xs-6">
                                        <div class="input-group input-group-sm mb-3">
                                            <span class="input-group-text">Verteidiger</span>
                                            <input name="defenderName" list="playerNames" placeholder="Account" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-xs-6">
                                        <div class="input-group input-group-sm mb-3">
                                            <span class="input-group-text">Speicher unter:</span>
                                            <input type="number" name="storageLevel" placeholder="0" class="form-control" max-length="2">
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-xs-6">
                                        <div class="input-group input-group-sm mb-3">
                                            <span class="input-group-text">Bauernhof unter:</span>
                                            <input type="number" name="farmLevel" placeholder="0" class="form-control" max-length="2">
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-xs-6">
                                        <div class="input-group input-group-sm mb-3">
                                            <span class="input-group-text">Schmiede unter:</span>
                                            <input type="number" name="smithLevel" placeholder="0" class="form-control" max-length="2">
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-xs-6">
                                        <div class="input-group input-group-sm mb-3">
                                            <span class="input-group-text">Wachturm unter:</span>
                                            <input type="number" name="watchtowerLevel" placeholder="0" class="form-control" max-length="2">
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-xs-6">
                                        <div class="input-group input-group-sm mb-3">
                                            <span class="input-group-text">ZS unter:</span>
                                            <input name="moodUnder" placeholder="100" type="number" class="form-control" max-length="3">
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-xs-6">
                                    ...
                                    <div class="col-md-4 col-xs-6">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <input name="cataTarget" list="cataTargets" placeholder="Kapatultziel" class="form-control">
